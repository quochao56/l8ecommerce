                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="country" value="" placeholder="City name"
                                        wire:model="country">
                                    @error('country')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <p class="row-in-form fill-wife">
                                    <label class="checkbox-field">
                                        <input name="different-add" wire:model="ship_to_different" id="different-add"
                    ...
                    <div class="summary-item payment-method">
                        ...
                        <div class="wrap-address-billing">
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="text" name="card-no" value="" placeholder="Card Number 16 digits"
                                    wire:model="card_no">
                                @error('card_no')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <p class="row-in-form">
                                ...
                                <input type="text" name="exp-month" value="" placeholder="Expiry Month"
