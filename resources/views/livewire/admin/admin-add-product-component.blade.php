                        ...
                        <form action="" class="form-horizontal" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <textarea placeholder="Short Description" id="short_description" class="form-control input-md"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-danger btn-sm" wire:click.prevent="remove({{ $key }})">Delete</button>
                                </div>
                            </div>
                            @endforeach
